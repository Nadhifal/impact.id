...
export const landingSections: LandingSection[] = [
  ...
  },
  {
    ...
    subtitle:
      "Impact Score, Project Selesai — angka ditarik otomatis dari data, label bisa diubah",
    icon: "bar-chart"
  },
  {
    id: "ai-mentor",
  ...
  },
  {
    ...
    subtitle:
      "2 kartu: Personalized Path, Smart Portfolio — judul, deskripsi, gambar",
    icon: "sparkles"
  },
  {
    id: "proses-belajar",
...
export const settingsTabs: { id: SettingsTab; label: string }[] = [
  ...
  { id: "pengaturan", label: "Pengaturan platform" }
];
