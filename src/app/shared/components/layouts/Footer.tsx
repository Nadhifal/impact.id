...
/**
 * GlobalFooter — shared footer used across all portals:
 * Landing page, Auth, Siswa, Guru, Dinas Pendidikan, Admin
 */
    ...
    <footer className="bg-white border-t border-slate-100 py-12">
      ...
      <div className="md:hidden max-w-7xl mx-auto px-6 flex flex-col items-center gap-4 text-center">
        ...
        <div className="flex justify-center gap-6 text-xs font-semibold text-slate-500">
          <a href="#" className="hover:text-[#00473e] transition-colors">Kebijakan Privasi</a>
          <a href="#" className="hover:text-[#00473e] transition-colors">Syarat &amp; Ketentuan</a>
        </div>
      </div>
      ...
      <div className="hidden md:flex max-w-7xl mx-auto px-6 md:px-12 flex-row items-center justify-between gap-8">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 text-xs font-medium text-slate-500">
          <a href="#" className="hover:text-[#00473e] transition-colors">Syarat &amp; Ketentuan</a>
          <a href="#" className="hover:text-[#00473e] transition-colors">Kebijakan Privasi</a>
          <a href="#" className="hover:text-[#00473e] transition-colors">Bantuan</a>
          <a href="#" className="hover:text-[#00473e] transition-colors">Kontak</a>
        </div>
