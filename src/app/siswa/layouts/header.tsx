...
export function Header() {
  ...
  const navLinks = [
    ...
    { name: "Impact Map", href: "/siswa/impact-map" },
      ...
      <header className="sticky top-0 z-40 w-full bg-white border-b border-zinc-100 px-6 py-4 md:px-12">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
              ...
              {navLinks.map((link) => {
                ...
                return (
                  <Link
                    key={link.name}
                    href={link.href}
                    className={`text-sm font-semibold tracking-wide py-1.5 border-b-2 transition-all ${
                      isActive
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            <button
              className="p-2 text-zinc-400 hover:text-slate-800 hover:bg-zinc-50 rounded-full transition-all cursor-pointer relative"
            ...
            <button
              className="p-2 text-zinc-400 hover:text-slate-800 hover:bg-zinc-50 rounded-full transition-all cursor-pointer"
              aria-label="Settings"
            >
            ...
            {/* Profile Avatar */}
            <div className="relative w-9 h-9 rounded-full overflow-hidden border border-zinc-200">
              <Image
