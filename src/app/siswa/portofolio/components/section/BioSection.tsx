  ...
  return (
    <Card className="bg-white border border-zinc-100 shadow-md p-6 sm:p-8 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-6">
      <div className="flex flex-col md:flex-row items-center gap-6 w-full md:w-auto text-center md:text-left">
        <div className="relative w-24 h-24 rounded-full overflow-hidden border-4 border-emerald-400/30 shrink-0">
          <Image
            src={bio.avatarUrl}
            alt={bio.name}
            fill
      ...
      <div className="flex items-center gap-3 w-full md:w-auto justify-center">
        <Button className="bg-primary hover:bg-primary-hover text-white py-3 px-5 rounded-xl flex items-center gap-2 text-xs font-bold shadow-md cursor-pointer">
          <Share2 className="w-4 h-4" />
          Bagikan Profil
        </Button>
        <Button variant="outline" className="border border-zinc-200 hover:border-zinc-300 text-slate-800 py-3 px-5 rounded-xl flex items-center gap-2 text-xs font-bold cursor-pointer">
