...
- **Tanggal perubahan**: Sabtu, 20 Juli 2026
...
### 3. Pembuatan Profile Saat Registrasi Murid & Guru- **Tanggal perubahan**: Sabtu, 20 Juli 2026- **Masalah**: Proses registrasi akun murid/guru berhasil, tetapi data asal sekolah, kota, dan provinsi tidak tersimpan ke database karena tabel `Profile` tidak dibuat. Di dashboard Dinas, data murid dikelompokkan sebagai `"SMA tidak diketahui"`.
